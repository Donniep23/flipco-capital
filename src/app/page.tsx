...
export default function HomePage() {
  ...
  // Site settings state with defaults
  ...
  // Load site settings and investment opportunities from Supabase
  useEffect(() => {
    loadSettings();
    loadOpportunities();
  }, []);
    ...
    <div className="min-h-screen relative">
      ...
      <div className="relative z-10">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              ...
              <div className="hidden md:flex items-center space-x-6">
                <a href="#home" className="text-slate-900 font-semibold hover:text-blue-600 transition-colors">Home</a>
                <a href="/about" className="text-slate-900 font-semibold hover:text-blue-600 transition-colors">About</a>
                <a href="/projects" className="text-slate-900 font-semibold hover:text-blue-600 transition-colors">Projects</a>
                <a href="#contact" className="text-slate-900 font-semibold hover:text-blue-600 transition-colors">Contact</a>
                <a href="/login" className="text-slate-900 font-semibold hover:text-blue-600 transition-colors">Investor Portal</a>
                <a href="/contractor-login" className="text-slate-900 font-semibold hover:text-green-600 transition-colors">Contractor Portal</a>
                <a href="#faq" className="text-slate-900 font-semibold hover:text-blue-600 transition-colors">FAQ</a>
              ...
              <div className="space-y-8">
                <div className="space-y-4">
                  <h1 className="text-5xl lg:text-6xl font-bold text-white leading-tight drop-shadow-lg">
                    {settings.hero_title}
                    <span className="text-blue-400 block">{settings.hero_subtitle}</span>
                  </h1>
                ...
                <div className="grid grid-cols-3 gap-8 pt-8 border-t border-white border-opacity-30">
                  <div className="text-center">
                    <div className="text-3xl font-bold text-blue-400 drop-shadow-lg">{settings.total_properties}+</div>
                    <div className="text-sm text-gray-100 drop-shadow-md">Properties Flipped</div>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl font-bold text-blue-400 drop-shadow-lg">{settings.average_roi}%</div>
                    <div className="text-sm text-gray-100 drop-shadow-md">Average ROI</div>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl font-bold text-blue-400 drop-shadow-lg">{settings.stats_transparency}</div>
        ...
        <section id="process" className="py-16 bg-slate-50/90 backdrop-blur-sm">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-slate-900 mb-4">{settings.section_process_title}</h2>
              <p className="text-xl text-slate-600">{settings.section_process_subtitle}</p>
        ...
        <section id="features" className="py-16 bg-white/90 backdrop-blur-sm">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-slate-900 mb-4">{settings.section_features_title}</h2>
              <p className="text-xl text-slate-600">{settings.section_features_subtitle}</p>
            </div>
        ...
        <section id="opportunities" className="py-16 bg-white/90 backdrop-blur-sm">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-slate-900 mb-4">{settings.section_opportunities_title}</h2>
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                {settings.section_opportunities_subtitle}
              </p>
            </div>
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex space-x-3">
                        <Button asChild className="flex-1 bg-blue-600 hover:bg-blue-700">
                          <a href="#contact">Reserve Your Spot</a>
                        </Button>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-slate-700">{settings.company_phone}</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <Mail className="h-5 w-5 text-blue-600" />
                    <span className="text-slate-700">{settings.company_email}</span>
                  </div>
                </div>

                <div className="mt-8 p-6 bg-blue-50 rounded-xl">
                  <h3 className="text-lg font-semibold text-blue-900 mb-2">Investment Minimums</h3>
                  <p className="text-blue-700">Starting at {settings.minimum_investment} per project</p>
