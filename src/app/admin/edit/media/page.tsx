          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500">Manage images, videos, and documents</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <Card>
          <CardContent className="flex items-center justify-center h-64">
            <div className="text-center">
              ...
              <h3 className="text-lg font-medium text-slate-900 mb-2">Media Manager Coming Soon</h3>
