...
ALTER TABLE site_settings ADD COLUMN IF NOT EXISTS stats_transparency TEXT DEFAULT '100% Transparency';
...
UPDATE site_settings SET
  ...
  stats_transparency = '100% Transparency',
  ...
  section_opportunities_subtitle = 'Partner with us on these vetted, high-potential fix-and-flip projects.',
